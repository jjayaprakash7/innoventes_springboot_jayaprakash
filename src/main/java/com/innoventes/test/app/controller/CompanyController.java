...
public class CompanyController {
	...
	public ResponseEntity<?> getCompanyById(@PathVariable(value = "id") Long id)throws ResourceNotFoundException {
	    try {
	...
	@GetMapping("/companies/by-code")
	public ResponseEntity<?> getCompanyByCode(@RequestParam(value = "companyCode") String companyCode)
			throws ResourceNotFoundException, InvalidAttributesException {
		try {
	...
	public ResponseEntity<CompanyDTO> updateCompanyPartial(@PathVariable Long id,
			@RequestBody Map<String, Object> updateCompany) {
		Company updatedCompany = companyService.updateCompanyByFields(id, updateCompany);
		return ResponseEntity.ok(companyMapper.getCompanyDTO(updatedCompany));
	}
