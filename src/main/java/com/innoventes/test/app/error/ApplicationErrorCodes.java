...
public class ApplicationErrorCodes {
	...
	public static final String COMPANY_CODE_NOT_FOUND = "company.code.notfound";
	public static final String COMPANY_CODE_CANNOT_BLANK="Company.code.cannot be blank.";
